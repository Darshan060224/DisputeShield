...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path={"/seller-space"} component={SellerSpace} />
      <Route path={"/customer-space"} component={CustomerSpace} />
      <Route path={"/operations/:section"} component={OperationsWorkspace} />
