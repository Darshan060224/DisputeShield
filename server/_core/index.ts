...
import { registerEvidenceUpload } from "../evidence";
...
async function startServer() {
  ...
  // Razorpay signature verification requires the unmodified request bytes.
  registerRazorpayWebhook(app);
  // The protected customer-document procedure limits base64 input to 5 MB.
  // Keep generic JSON parsing below that boundary's practical request envelope.
